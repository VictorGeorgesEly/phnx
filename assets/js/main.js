      ...
      if ($countdown.length) {
        ...
        $countdown.countDown({
          targetDate: {
            ...
            'hour':     _countdown_date[3],
            'min':      _countdown_date[4],
            'sec':      _countdown_date[5],
...
setInterval(function () {
  if (new Date() > new Date(_countdown_date[0], _countdown_date[1] - 1, _countdown_date[2], _countdown_date[3], _countdown_date[4], _countdown_date[5])) {
    _countdown_date = [2017, 2, 2, 23, 0, 0];
    fn_countdown();
  }
}, 1000);
        ...
        $form.validate({
            ...
            submitHandler: function(form) {
                $(form).ajaxSubmit({
                    ...
                    error: function(data) {
                        $formNotify.removeClass('valid').addClass('error').html('<i class="fa fa-warning"></i> Une erreur est survenue, merci de réessayer plus tard ou de nous envoyer un mail directement via <i>phnx@juniorisep.com</i></i>.').show();
                    },
                });
            },
            invalidHandler: function(event, validator) {
                ...
                if (errors) {
                    var message = '<i class="fa fa-warning"></i> Tous les champs sont obligatoires.';
      ...
      invalidHandler: function(event, validator) {
        ...
        if (errors) {
          var message = errors == 1 ?
            '<i class="fa fa-warning"></i>Veuillez renseigner une adresse mail valide !' :
            '<i class="fa fa-warning"></i>Veuillez renseigner une adresse mail valide !';
