...
var _countdown_date =                             [2017, 2, 2, 23, 0, 0]; // [2016, 12, 1] mean 2016[year] - 12[month] - 01[day]
...
// --------------------------------------------------
var r = /static/;
var _site_bg_effect =                             r.exec(window.location) == null ? 1 : 0; // 0 = disable, 1 = cloud, 2 = constellation, 3 = parallax star star,
...
var _cloud_opacity =                              0.2; // [0.1 to 1] - cloud opacity

// if _bg_effect == 2 (constellation)

var _constellation_color =                        'rgba(153, 79, 199, 0.9)';// [rgba format] - constellation color
